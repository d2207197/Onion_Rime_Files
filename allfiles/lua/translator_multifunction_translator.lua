...
--- 擴充模式 \r\n    日期 (年月日) ~d \r\n    年 ~y  月 ~m  日 ~day \r\n    年月 ~ym  月日 ~md \r\n    時間 (時分) ~n   (時分秒) ~t \r\n    日期時間 (年月日時分) ~dn\r\n    日期時間 (年月日時分秒) ~dt
    ...
    if (input == env.prefix .. "kj") then
      local keys_table = {
        ...
        , { "外來語：", "３７" }
        , { "　いぃ/イィ yi　いぇ/イェ ye　", "３８" }
        , { "　うゅ/ウュ wyu　", "３９" }
        , { "　うぁ/ウァ wha　うぃ/ウィ whi (wi)　うぅ/ウゥ whu　うぇ/ウェ whe (we)　うぉ/ウォ who　", "４０" }
        , { "　ゔぁ/ヴァ va　ゔぃ/ヴィ vi (vyi)　ゔぇ/ヴェ ve (vye)　ゔぉ/ヴォ vo　", "４１" }
        , { "　ゔゃ/ヴャ vya　ゔゅ/ヴュ vyu　ゔょ/ヴョ vyo　", "４２" }
        , { "　ゔぃぇ/ヴィェ vye　", "４３" }
        , { "　くぁ/クァ qwa　くぃ/クィ qwi (qyi)　くぅ/クゥ qwu　くぇ/クェ qwe (qye)　くぉ/クォ qwo　", "４４" }
        , { "　くぁ/クァ/くゎ/クヮ kwa　くぃ/クィ kwi　くぅ/クゥ kwu　くぇ/クェ kwe　くぉ/クォ kwo　", "４５" }
        , { "　くゃ/クャ qya　くゅ/クュ qyu　くょ/クョ qyo　", "４６" }
        , { "　ぐぁ/グァ/ぐゎ/グヮ gwa　ぐぃ/グィ gwi　ぐぅ/グゥ gwu　ぐぇ/グェ gwe　ぐぉ/グォ gwo　", "４７" }
        , { "　きぃ/キィ kyi　きぇ/キェ kye　", "４８" }
        , { "　ぎぃ/ギィ gyi　ぎぇ/ギェ gye　", "４９" }
        , { "　しぃ/シィ syi　しぇ/シェ sye (she)　", "５０" }
        , { "　じぃ/ジィ jyi (zyi)　じぇ/ジェ jye (je zye)　", "５１" }
        , { "　すぁ/スァ swa　すぃ/スィ swi　すぅ/スゥ swu　すぇ/スェ swe　すぉ/スォ swo　", "５２" }
        , { "　すゅ/スュ syu　", "５３" }
        , { "　ずゅ/ズュ zyu　ずぃ/ズィ zwi　ずゎ/ズヮ zwa　", "５４" }
        , { "　ちぃ/チィ cyi (tyi)　ちぇ/チェ che (cye tye)　", "５５" }
        , { "　ぢぃ/ヂィ dyi　ぢぇ/ヂェ dye　", "５６" }
        , { "　てゃ/テャ tha　てぃ/ティ thi　てぇ/テェ the　てょ/テョ tho　", "５７" }
        , { "　てゅ/テュ thu (tyu)　", "５８" }
        , { "　でゃ/デャ dha　でぃ/ディ dhi　でぇ/デェ dhe　でょ/デョ dho　", "５９" }
        , { "　でゅ/デュ dhu (dyu)　", "６０" }
        , { "　つぁ/ツァ tsa　つぃ/ツィ tsi　つぇ/ツェ tse　つぉ/ツォ tso　", "６１" }
        , { "　つゅ/ツュ tsyu　", "６２" }
        , { "　とぁ/トァ twa　とぃ/トィ twi　とぅ/トゥ twu　とぇ/トェ twe　とぉ/トォ two　", "６３" }
        , { "　どぁ/ドァ dwa　どぃ/ドィ dwi　どぅ/ドゥ dwu　どぇ/ドェ dwe　どぉ/ドォ dwo　", "６４" }
        , { "　にぃ/ニィ nyi　にぇ/ニェ nye　", "６５" }
        , { "　ひぃ/ヒィ hyi　ひぇ/ヒェ hye　", "６６" }
        , { "　びぃ/ビィ byi　びぇ/ビェ bye　", "６７" }
        , { "　びゎ/ビヮ bwa　", "６８" }
        , { "　ぴぃ/ピィ pyi　ぴぇ/ピェ pye　", "６９" }
        , { "　ふぁ/ファ fwa (fa)　ふぃ/フィ fwi (fi fyi)　ふぅ/フゥ fwu　ふぇ/フェ fwe (fe fye)　ふぉ/フォ fwo (fo)　", "７０" }
        , { "　ふゃ/フャ fya　ふゅ/フュ fyu　ふょ/フョ fyo　", "７１" }
        , { "　ふぃぇ/フィェ fye　", "７２" }
        , { "　ぷゎ/プヮ pwa　", "７３" }
        , { "　ほぅ/ホゥ hwu　", "７４" }
        , { "　みぃ/ミィ myi　みぇ/ミェ mye　", "７５" }
        , { "　りぃ/リィ ryi (lyi)　りぇ/リェ rye (lye)　", "７６" }
        }
      for k, v in ipairs(keys_table) do
        local cand = Candidate("tips", seg.start, seg._end, v[2], " " .. v[1])
